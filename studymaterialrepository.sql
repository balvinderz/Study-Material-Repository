...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2019 at 11:27 AM
...
INSERT INTO `faculty` (`srdno`, `name`, `email`, `password`) VALUES
('', 'balvinder', 'balvi', ''),
...
('1111', 'sanjeel', 'ce', '6', 'sanjel@gmail.com', '1234'),
...
INSERT INTO `studymaterial` (`id`, `srdno`, `title`, `description`, `subject`, `sem`, `path`) VALUES
(1, '21', 'mkdmakmk', 'mksmdkmmfkds', 'ADA', 'V', '../documents/rait_new.png');
